public class Unit6ExercisesTester {
    ...
    private static void testSumDigits() {
        ...
        // Recursive tests
        System.out.println("Sum of Digits (Recursive) of 123: " + Unit6Exercises.sumDigitsRecursive(123)); // Expected:
                                                                                                           // 6
        System.out.println("Sum of Digits (Recursive) of 0: " + Unit6Exercises.sumDigitsRecursive(0)); // Expected: 0
        System.out.println("Sum of Digits (Recursive) of 456: " + Unit6Exercises.sumDigitsRecursive(456)); // Expected:
                                                                                                           // 15
    }
    ...
    private static void testCountX() {
        ...
        // Recursive tests
        System.out.println("Count X (Recursive) in 'axbxcxd': " + Unit6Exercises.countXRecursive("axbxcxd")); // Expected:
                                                                                                              // 3
    ...
    private static void testReverseString() {
        ...
        // Non-recursive tests
        System.out.println("Reverse String (Non-Recursive) of 'hello': " + Unit6Exercises.reverseString("hello")); // Expected:
                                                                                                                   // "olleh"
        System.out.println("Reverse String (Non-Recursive) of '': " + Unit6Exercises.reverseString("")); // Expected: ""
        System.out.println("Reverse String (Non-Recursive) of 'abc': " + Unit6Exercises.reverseString("abc")); // Expected:
                                                                                                               // "cba"

        // Recursive tests
        System.out.println("Reverse String (Recursive) of 'hello': " + Unit6Exercises.reverseStringRecursive("hello")); // Expected:
                                                                                                                        // "olleh"
        System.out.println("Reverse String (Recursive) of '': " + Unit6Exercises.reverseStringRecursive("")); // Expected:
                                                                                                              // ""
        System.out.println("Reverse String (Recursive) of 'abc': " + Unit6Exercises.reverseStringRecursive("abc")); // Expected:
                                                                                                                    // "cba"
    }
    ...
    private static void testIsPalindrome() {
        ...
        // Recursive tests
        System.out.println("Is 'racecar' a palindrome? " + Unit6Exercises.isPalindromeRecursive("racecar")); // Expected:
                                                                                                             // true
        System.out.println("Is 'hello' a palindrome? " + Unit6Exercises.isPalindromeRecursive("hello")); // Expected:
                                                                                                         // false
    ...
    private static void testBinarySearch() {
        ...
        // Non-recursive tests
        System.out.println("Binary Search (Non-Recursive) for 5: " + Unit6Exercises.binarySearch(arr, 5)); // Expected:
                                                                                                           // 4
        System.out.println("Binary Search (Non-Recursive) for 10: " + Unit6Exercises.binarySearch(arr, 10)); // Expected:
                                                                                                             // -1
        System.out.println("Binary Search (Non-Recursive) for 1: " + Unit6Exercises.binarySearch(arr, 1)); // Expected:
                                                                                                           // 0

        // Recursive tests
        System.out.println("Binary Search (Recursive) for 5: " + Unit6Exercises.binarySearchRecursive(arr, 5)); // Expected:
                                                                                                                // 4
        System.out.println("Binary Search (Recursive) for 10: " + Unit6Exercises.binarySearchRecursive(arr, 10)); // Expected:
                                                                                                                  // -1
        System.out.println("Binary Search (Recursive) for 1: " + Unit6Exercises.binarySearchRecursive(arr, 1)); // Expected:
                                                                                                                // 0
    }
}