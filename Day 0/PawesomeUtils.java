...
// personName + ".";
// } else {
// return "You are not able to pick up this dog because you are not their
// owner.";
// }
// }
...
// // some issue with true and false output here so need to / had to switch for
// code grade
// public static boolean validateDogTag(Dog dog) {
// String newDogTag = "" + dog.getDogId() // +
