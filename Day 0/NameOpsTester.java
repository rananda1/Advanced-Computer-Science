public class NameOpsTester {
    public static void main(String[] args) {
        ...
        // System.out.println(NameOps.whoIsAwesome(name1));
        // System.out.println(NameOps.indexOfFirstSpace(name2));
        // System.out.println(NameOps.indexOfSecondSpace(name3));
        // System.out.println("Testing First Name: " + NameOps.findFirstName(name3));
        // System.out.println(NameOps.findMiddleName(name3) + ".");
        // System.out.println(NameOps.findLastName(name2));
        // System.err.println(NameOps.generateLastFirstMidInitial(name3));
